...
<body>
					...
					<c:if test="${not empty board}">
						<c:forEach var="b" items="${board}">
							<div class="col-md-4 text-center poster_image">
								...
								<img class="poster_thumbnail" width="200" height="280" alt="이미지가 없음" style="margin: 10px;" src="<c:url value= '${b.imagePath}'/>"	/>
								</a>
	...
	<script>
		$(document).ready(function() {
	 	...
	 	/* 	$('.poster_thumbnail').hover(function() {
				$(this).closest('.poster_image')
					.find('.poster_content').css({
						'position': 'absolute',
				...
				$(this).closest('.poster_image')
					.find('.poster_content').css('display', 'none');
			});  */
